                ...
                child: Padding(
                    ...
                    child: Column(children: [
                      ...
                      [Padding(
                        ...
                        child: Container(decoration: BoxDecoration(border: Border.all(color: Colors.black,style: BorderStyle.none),borderRadius: BorderRadius.circular(15.0),color: Colors.amber),
                        ...
                        Column(children: [Padding(
                          padding: const EdgeInsets.all(3.0),
                          child: Container(decoration: BoxDecoration(border: Border.all(color: Colors.black,style: BorderStyle.none),borderRadius: BorderRadius.circular(15.0),color: Colors.lightBlue),
